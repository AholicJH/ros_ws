...
(cl:in-package learn_service-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <IntPlus-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IntPlus-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name learn_service-srv:<IntPlus-request> is deprecated: use learn_service-srv:IntPlus-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <IntPlus-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learn_service-srv:a-val is deprecated.  Use learn_service-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <IntPlus-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learn_service-srv:b-val is deprecated.  Use learn_service-srv:b instead.")
  (b m))
...
(cl:defmethod cl:initialize-instance :after ((m <IntPlus-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IntPlus-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name learn_service-srv:<IntPlus-response> is deprecated: use learn_service-srv:IntPlus-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <IntPlus-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learn_service-srv:result-val is deprecated.  Use learn_service-srv:result instead.")
  (result m))
