...
(cl:defmethod cl:initialize-instance :after ((m <DoDishesGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DoDishesGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name learn_action-msg:<DoDishesGoal> is deprecated: use learn_action-msg:DoDishesGoal instead.")))

(cl:ensure-generic-function 'dishwasher_id-val :lambda-list '(m))
(cl:defmethod dishwasher_id-val ((m <DoDishesGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learn_action-msg:dishwasher_id-val is deprecated.  Use learn_action-msg:dishwasher_id instead.")
  (dishwasher_id m))
