...
(cl:defmethod cl:initialize-instance :after ((m <DoDishesResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DoDishesResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name learn_action-msg:<DoDishesResult> is deprecated: use learn_action-msg:DoDishesResult instead.")))

(cl:ensure-generic-function 'total_dishes_cleaned-val :lambda-list '(m))
(cl:defmethod total_dishes_cleaned-val ((m <DoDishesResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learn_action-msg:total_dishes_cleaned-val is deprecated.  Use learn_action-msg:total_dishes_cleaned instead.")
